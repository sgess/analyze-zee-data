...
for i=0:5
    ...
    BG1_0 = load(['~/Desktop/shake data/XCS_start_0840.aps/mat/MAT18/DPsv0000' num2str(i) '.mat']);
...
% for i=1:9
%     
%     BGTS = BG_TS(:,2,1,i) + BG_TS(:,2,2,i) + BG_TS(:,2,3,i) + BG_TS(:,2,4,i) + BG_TS(:,2,5,i) + BG_TS(:,2,6,i);
%     BGTSAVG(:,i) = BGTS/6;
%     
%     figure;
%     plot(BG_TS(:,1,1,i),BG_TS(:,2,1,i),'r.',BG_TS(:,1,2,i),BG_TS(:,2,2,i),'b.',BG_TS(:,1,3,i),BG_TS(:,2,3,i),'m.',...
%         BG_TS(:,1,4,i),BG_TS(:,2,4,i),'y.',BG_TS(:,1,5,i),BG_TS(:,2,5,i),'g.',BG_TS(:,1,6,i),BG_TS(:,2,6,i),'c.',BG_TS(:,1,1,i),BGTSAVG(:,i),'k');
%     xlabel('Time (s)');
%     ylabel('Acceleration (g)');
%     title(chan_list{i});
%     legend('Set 1','Set 2','Set 3','Set 4','Set 5','Set 6','Avg');
%     saveas(gcf,['plots/BG18/TSChan_' num2str(i) '.pdf']);
% end
...
%     title(chan_list{i});
%     legend('Set 1','Set 2','Set 3','Set 4','Set 5','Set 6','Avg');
%     saveas(gcf,['plots/BG18/Chan_' num2str(i) '.pdf']);
% end
% 
% figure;
...
% saveas(gcf,'plots/BG18/LODCM_.pdf');
% 
% figure;
